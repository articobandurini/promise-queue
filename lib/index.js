...
(this, function () {
    ...
    Queue.prototype.add = function (promiseGenerator) {
        return this._genericAdd('push')(promiseGenerator);
    };
     ...
     * @return {LocalPromise}
     */
    Queue.prototype.addNow = function (promiseGenerator) {
        return this._genericAdd('unshift')(promiseGenerator);
    };

    /**
     * @param {number} maxPendingPromises
     */
    Queue.prototype.setMaxPendingPromises = function (maxPendingPromises) {
        this.maxPendingPromises = typeof maxPendingPromises !== 'undefined' ? maxPendingPromises : Infinity
    };
     ...
     * @private
     */
    Queue.prototype._genericAdd = function (type) {
        var self = this;
